...
# --- Btn 3: Planteamiento del Problema ---
    ...
    # --- Btn 4: Objetivos y Justificación ---
        ...
        return html.Div([
            ...
            html.H5("Objetivos Específicos", className="text-secondary fw-bold mb-3"),
            dbc.Row([
                # Objetivo 1
                dbc.Col(dbc.Card([
                    dbc.CardBody([
            ...
            dbc.Row([
                ...
                dbc.Col([
                    html.Div(className="p-3 border rounded h-100 bg-white shadow-sm", children=[
                        html.H6([html.I(className="bi bi-exclamation-circle me-2 text-primary"), "El Contexto"], className="fw-bold mb-3"),
                        html.P(
                ...
                dbc.Col([
                    html.Div(className="p-3 border rounded h-100 bg-white shadow-sm", children=[
                        html.H6([html.I(className="bi bi-search me-2 text-primary"), "El Análisis"], className="fw-bold mb-3"),
                        html.P(
                ...
                dbc.Col([
                    html.Div(className="p-3 border rounded h-100 bg-white shadow-sm", children=[
                        html.H6([html.I(className="bi bi-check-circle me-2 text-primary"), "El Aporte"], className="fw-bold mb-3"),
                        html.P(
...
# -------------------------------------------------
dbc.Tab(label="Evaluación del Modelo", children=[
    dbc.CardBody([
        dbc.Container([
